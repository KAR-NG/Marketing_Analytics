...
```
Though inspecting the table visually is an option, but I would use code to done the job for me. Following codes help me to check the presence of correlation values that are higher than 0.8, and not 1. 
